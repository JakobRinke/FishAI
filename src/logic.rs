...
impl GameClientDelegate for OwnLogic {
    ...
    fn request_move(&mut self, state: &State, _my_team: Team) -> Move {
        ...
        //let a: &[f32] = &[1.0, -0.8017075937684055, 0.1, 0.4, 20.0, 1.2];

      //  let a: &[f32] = &[1.0, -2.8017075937684055, 0.15, 1.435609120279965, 8.0, 0.2];

        let a: &[f32] = &[1.8509686217366212, -4.510831156467119, -1.9237961917478072, -4.134668419156508, 2.4400472142636165, 1.0910846883723142];
